...
function tellMe(joke) {
    VoiceRSS.speech({
    key: '7ddd6035788c4042bf6c56caff3e4a8f',
    src: joke,
    hl: 'en-us',
    r: 0,
    c: 'mp3',
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Miscellaneous,Dark,Pun?blacklistFlags=nsfw,religious,political,racist,sexist,explicit';
